...
const ROLE_LABELS: Record<string, string> = {
  ...
  managing_pharmacist: 'Mng. Pharmacist',
};

const PharmacistTab: React.FC = () => {
  ...
  const staff = (data?.results ?? []).filter(
    (s) => s.role === 'pharmacist' || s.role === 'managing_pharmacist',
  );
  ...
  return (
    <div>
      <DataTable columns={columns} data={staff} loading={loading} emptyMessage="No pharmacists found" />
      {staff.map((s) => (
